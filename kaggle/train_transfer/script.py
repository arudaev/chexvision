#!/usr/bin/env python3
"""CheXVision — Train DenseNet-121 Transfer Learning (Kaggle Kernel).
...
CONFIG_PATH = REPO_DIR / "configs" / "transfer.yaml"
...
with open(CONFIG_PATH) as f:
    transfer_cfg = yaml.safe_load(f)

# Deep-merge transfer overrides into default
...
config = _deep_merge(config, transfer_cfg)
...
if hf_token:
    ...
    best_ckpt = ckpt_dir / "CheXVision-DenseNet_best.pth"
